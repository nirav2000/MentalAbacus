/* engine.js - Adaptive difficulty engine
   Handles strategy selection, difficulty adjustment, and mastery assessment.
*/
...
const AdaptiveEngine = {
    ...
    selectStrategy(playerId) {
        ...
        // Weight by: how much they need it + how long since last practice
        const now = Date.now();
    ...
    getSessionPlan(playerId, specificStrategy) {
        ...
        for (let i = 0; i < this.SESSION_LENGTH; i++) {
            // First 2 questions: warm-up with auto-selected (if not specific)
