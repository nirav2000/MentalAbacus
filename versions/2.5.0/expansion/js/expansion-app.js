...
import { getActiveMisunderstandings, getRemediationPriority } from './diagnostics/misunderstanding-tracker.js';
...
function renderDiagnosticsScreen(root, params = {}) {
  ...
  setTimeout(() => {
    ...
    // Handle results buttons (if on results screen)
    const startLearningBtn = document.getElementById('start-learning');
    const backHomeBtn = document.getElementById('back-home');

    if (startLearningBtn) {
      startLearningBtn.addEventListener('click', () => {
        // Go to first suggested strategy
