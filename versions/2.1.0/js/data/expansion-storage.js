...
function createDefaultData() {
  return {
    ...
    subtractionFacts: {
      strategyGroups: {
        counting_back: { status: 'locked', percentComplete: 0 },
        subtracting_0: { status: 'locked', percentComplete: 0 },
        think_addition: { status: 'locked', percentComplete: 0 },
        doubles_subtraction: { status: 'locked', percentComplete: 0 },
        subtract_from_10: { status: 'locked', percentComplete: 0 },
